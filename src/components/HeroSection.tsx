...
const HeroSection: FC<HeroSectionProps> = () => {
  ...
  return (
    <section className="relative min-h-[75vh] sm:min-h-[85vh] flex items-center overflow-hidden bg-brand-blue">
      <Image
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <h1 className="font-heading text-2xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-3 sm:mb-4">
            {HERO_HEADLINE}
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-5 sm:mb-6">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-brand-saffron text-white font-semibold 
                         rounded-lg px-6 py-4 h-14 text-lg hover:bg-orange-700 transition-colors shadow-lg"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 bg-brand-wa text-white font-semibold 
                         rounded-lg px-6 py-4 h-14 text-lg hover:bg-green-600 transition-colors shadow-lg"
            >
